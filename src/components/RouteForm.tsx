...
export default function RouteForm({ userType, title, routeQuestion }: RouteFormProps) {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="pt-28 pb-20 max-w-2xl mx-auto px-6">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 text-center">{title}</h1>
        <p className="text-center text-gray-500 mb-10">
          {userType === "transportista"
            ? "Publica tu ruta de retorno y gana dinero con el espacio disponible."
            : "Publica tu envío y encuentra transporte económico."}
        </p>
